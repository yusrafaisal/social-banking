...
filter_extraction_prompt = PromptTemplate(
    ...
    - description (string: McDonalds, Foodpanda, Careem, JazzCash, Daraz, Zong, Amazon, Uber, Netflix, Grocery Store etc.)
    - category (string: Food, Travel, Telecom, Groceries, Shopping, Finance, Utilities, Income, Entertainment, Loan, Transfer, Refund etc.)
